        ...
        return (
            <div className="min-h-screen bg-[#f5f5f7] dark:bg-black flex items-center justify-center px-4">
                <motion.div
                    ...
                    className="max-w-md w-full bg-white dark:bg-black/40 backdrop-blur-3xl rounded-[2.5rem] p-12 text-center shadow-xl transition-all duration-700 border border-transparent dark:border-white/5"
                >
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="grid md:grid-cols-1 gap-16">
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 bg-[#f5f5f7] dark:bg-black/40 backdrop-blur-3xl p-8 md:p-12 rounded-[2.5rem] border border-transparent dark:border-white/5 shadow-xl transition-all duration-700">
