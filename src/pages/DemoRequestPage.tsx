        ...
        return (
            <div className="min-h-screen bg-[#f5f5f7] dark:bg-black flex items-center justify-center px-4">
                <motion.div
                    ...
                    className="max-w-md w-full bg-white dark:bg-[#1d1d1f] rounded-[2.5rem] p-12 text-center shadow-2xl space-y-8"
                >
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="grid md:grid-cols-1 gap-16">
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 bg-[#f5f5f7] dark:bg-[#1d1d1f] p-8 md:p-12 rounded-[2.5rem] shadow-sm border border-transparent hover:border-[#e5e5e7] dark:hover:border-[#333] transition-all duration-500">
