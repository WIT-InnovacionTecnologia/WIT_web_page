            ...
            <div className="max-w-7xl mx-auto px-6">
                {features.map((feature, idx) => (
                    ...
                    >
                        ...
                        >
                            <div className="relative w-full max-w-full h-full bg-[#f5f5f7] dark:bg-[#111111] p-1.5 rounded-[1.8rem] shadow-2xl ring-1 ring-black/5 dark:ring-white/5 group overflow-hidden box-border border border-transparent dark:border-white/5">
